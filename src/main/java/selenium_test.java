...
public class selenium_test {
    public static void seleniumTest(String ssidname, String pwd, String lanip, String adminname, String adminpwd){
        try {
            OpenShell getPwd = new OpenShell();
            String realPwd = getPwd.AdminPwd();
            String finalUrl = "http://admin:" + realPwd + "@" + lanip + "/basic_auth";

            System.setProperty("webdriver.gecko.driver", "/home/network-18/IdeaProjects/selenium_test/src/main/java/geckodriver");
            WebDriver driver = new FirefoxDriver(); //ウェブドライバ起動
            ...
            changeSsid.clear();
            changeSsid.sendKeys(ssidname);
            changeSsid.submit(); //ssid変更
            ...
            takePwd.click();
            String APpwd = takePwd.getAttribute(pwd);
